"""
Django settings for TecnoVenta project.
...
SECRET_KEY = 'django-insecure-#3balvt*p7ky%=!d-1hqn-px#g9!ifoe(k2kk*@^0@$i3uojp#'
...
EMAIL_USE_TLS=True
EMAIL_PORT=587
EMAIL_HOST_USER="fabisick@gmail.com"
EMAIL_HOST_PASSWORD="ZxcV5637"
